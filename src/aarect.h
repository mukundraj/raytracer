...
class xy_rect : public hittable{
  public:
    ...
    virtual bool bounding_box(double time0, double time1, aabb& output_box) const override {
      // padding for nonzero width in each dimension
...
class xz_rect : public hittable{
  public:
    ...
    virtual bool bounding_box(double time0, double time1, aabb& output_box) const override {
      // padding the plane's bounding bounding_box
      output_box = aabb(point3(x0, k-0.0001, z0), point3(z1, k+0.0001, z1));
      return true;
    }
...
class yz_rect : public hittable{
  public:
    ...
    virtual bool bounding_box(double time0, double time1, aabb& output_box) const override{
      // padding the plane's  bounding box
